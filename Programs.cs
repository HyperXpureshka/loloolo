...
internal static class ProgramHelpers
{
    ...
    //        Console.WriteLine("Сумма элементов между первым отрицательным и нулевым элементами: " + sum);
    ...
    //        Console.WriteLine("\nРезультирующий массив после удаления элементов, встречающихся более двух раз:");
    ...
    //        Console.WriteLine("\nОтсортированный массив (отрицательные и нули в начале, положительные в конце):");
